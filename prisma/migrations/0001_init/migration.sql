...
\restrict NFyoFY3sUxF1QBXP4nv9nriVal7THXx6MfyWR4AcRsbUKw3vprhDlRhgAem9Y5N
...
COPY public.auth_sessions (id, user_id, refresh_token, expires_at, created_at, revoked_at, ip, user_agent) FROM stdin;
\.
...
COPY public.comments (id, review_id, user_id, parent_id, body, status, created_at, updated_at) FROM stdin;
\.
...
COPY public.complaints (id, user_id, target_type, target_id, reason, status, created_at, updated_at, resolved_at) FROM stdin;
\.
...
--
-- Data for Name: film_countries; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.film_countries (film_id, country_id, created_at) FROM stdin;
\.
...
COPY public.film_genres (film_id, genre_id, created_at) FROM stdin;
\.


--
-- Data for Name: film_person_roles; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.film_person_roles (id, film_id, person_id, role_type, character_name, billing_order, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: film_tags; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.film_tags (film_id, tag_id, created_at) FROM stdin;
\.
...
COPY public.films (id, title, original_title, description, release_year, duration_min, age_rating, status, average_rating, ratings_count, popularity_score, created_at, updated_at) FROM stdin;
\.
...
COPY public.genres (id, name, slug, description, status, created_at, updated_at) FROM stdin;
\.
...
COPY public.moderation_actions (id, moderator_id, target_type, target_id, action_type, reason, created_at, complaint_id) FROM stdin;
\.
...
COPY public.persons (id, full_name, slug, birth_date, death_date, bio, status, created_at, updated_at) FROM stdin;
\.
...
COPY public.ratings (id, user_id, film_id, score, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: review_versions; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.review_versions (id, review_id, version_number, title, body, created_at, edited_by_user_id) FROM stdin;
\.
...
COPY public.reviews (id, film_id, user_id, status, current_version_id, created_at, updated_at) FROM stdin;
\.
...
COPY public.tags (id, name, slug, description, status, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: user_list_items; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.user_list_items (id, list_id, user_id, film_id, "position", note, created_at) FROM stdin;
\.


--
-- Data for Name: user_lists; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.user_lists (id, user_id, name, type, is_public, created_at, updated_at) FROM stdin;
\.
...
COPY public.users (id, email, password_hash, display_name, status, created_at, updated_at, last_login_at) FROM stdin;
\.
...
\unrestrict NFyoFY3sUxF1QBXP4nv9nriVal7THXx6MfyWR4AcRsbUKw3vprhDlRhgAem9Y5N
