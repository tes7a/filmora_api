...
const SIMILAR_SORT_BY = ['similarity', 'rating', 'date', 'popularity'] as const;
const SORT_ORDER = ['asc', 'desc'] as const;

export type SimilarSortBy = (typeof SIMILAR_SORT_BY)[number];
export type SimilarSortOrder = (typeof SORT_ORDER)[number];
...
export class GetSimilarFilmsQueryDto {
  @ApiPropertyOptional({
  ...
  @ApiPropertyOptional({
    ...
    enum: SIMILAR_SORT_BY,
    default: 'similarity',
  })
  @IsIn(SIMILAR_SORT_BY)
  sortBy: SimilarSortBy = 'similarity';
  ...
  @IsIn(SORT_ORDER)
  sortOrder: SimilarSortOrder = 'desc';
