...
const RECOMMENDATIONS_SORT_BY = ['rating', 'date', 'popularity'] as const;
const SORT_ORDER = ['asc', 'desc'] as const;

export type RecommendationsSortBy = (typeof RECOMMENDATIONS_SORT_BY)[number];
...
export class GetRecommendationsQueryDto {
  ...
  @ApiPropertyOptional({
    ...
    enum: RECOMMENDATIONS_SORT_BY,
  })
  @IsOptional()
  @IsIn(RECOMMENDATIONS_SORT_BY)
  sortBy?: RecommendationsSortBy;
